...
assert_status "Known but unsupported PUT returns 405" "405" "$R"
R="$(raw_http 8080 $'HEAD / HTTP/1.1\r\nHost: localhost\r\n\r\n')"
assert_status "Known but unsupported HEAD returns 405" "405" "$R"
R="$(http -X SOMETHING http://127.0.0.1:8080/)"
assert_status "Unknown method returns 501" "501" "$R"
